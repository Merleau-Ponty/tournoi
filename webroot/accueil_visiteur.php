...
<span id="liste_tournoil"><a href="liste_match.php" style="text-decoration:none; color: black;">Lister les matchs</span></a>
    ...
    <span id="inscription_logo">    
        <a href="inscription_visiteur.php" style="text-decoration:none; color: black;"><img src="img/Capture1.PNG" width="200" height="200" alt=""/></a>
    </span>
    <span id="liste_joueur">
        <a href="liste_inscrit.php" style="text-decoration:none; color: black;"><img src="img/Capture2.PNG" width="200" height="200" alt=""/></a>
    </span>
    <span id="liste_tournoi">
        <a href="liste_match.php" style="text-decoration:none; color: black;"><img src="img/Capture3.PNG" width="200" height="210" alt=""/></a>
    </span>
    </p>
