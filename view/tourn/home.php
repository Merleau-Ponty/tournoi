...
<span id="liste_joueurl"><a href="<?= BASE_URL ?>/tourn/liste_inscrit" style="text-decoration:none; color: black;">Lister les Inscrits</span></a>
<span id="liste_tournoil"><a href="<?= BASE_URL ?>/tourn/liste_match" style="text-decoration:none; color: black;">Lister les matchs</span></a>
    </p>
    <p id="choixjoueur">
